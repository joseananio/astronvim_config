...
return {
  "AstroNvim/astrolsp",
  -- Telescope ships with AstroNvim core, but adding it here guarantees
  -- the module is on the runtime-path before our key-callbacks fire.
  ...
  opts = {
    ...
    servers = {
      ...
      pyright = {
        settings = {
          python = {
            -- expand the tilde so pyright sees an absolute path
    ...
    mappings = {
      n = {
        ...
        ----------------------------------------------------------------
        -- Telescope pickers for the gr* family                       --
        ----------------------------------------------------------------
        grr = {
        ...
        gra = {
          ...
          desc = "LSP code-actions (Telescope)",
        },
      },
    },
